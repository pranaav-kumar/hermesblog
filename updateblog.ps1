...
$sourcePath = "C:\personal vault\pranaav\posts"
$destinationPath = "C:\Users\jpran\Documents\hermesblog\content\posts"

# Set Github repo 
$myrepo = "git@github.com:pranav-kumar/hermesblog.git"
